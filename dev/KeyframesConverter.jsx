...
_buildGUI = function ()
{
    ...
    var l_wnd = new Window("dialog", "Keyframes Converter", undefined);
    _fWindow_wnd = l_wnd;

    var lListboxContainer_panel = l_wnd.add("panel", undefined, "Double click on item to move it between groups");
    ...
    l_wnd.settings = l_wnd.add("group", undefined, {name:"settings"});
    l_wnd.settings.alignChildren = ["fill", "fill"];
    l_wnd.settings.orientation = "row";

    l_wnd.settings.properties = l_wnd.settings.add("panel", undefined, "Properties", {name:"properties"});
    l_wnd.settings.properties.alignChildren = ["fill", "top"];

    for (var i = 0; i < _PROPERTIES.length; i++)
    {
        var lProperty_cb = l_wnd.settings.properties.add("checkbox", undefined, _PROPERTIES[i], {name:"property_" + i}); 
        lProperty_cb.value = true;
    }

    l_wnd.settings.properties.property_0.onClick = function ()
    {
        l_wnd.settings.gut.sxsy_mode.enabled = l_wnd.settings.properties.property_0.value;
    }

    l_wnd.settings.properties.property_1.onClick = function ()
    {
        l_wnd.settings.gut.xy_mode.enabled = l_wnd.settings.properties.property_1.value;
        l_wnd.positioning.enabled = l_wnd.settings.properties.property_1.value;
    }

    l_wnd.settings.mode = l_wnd.settings.add("panel", undefined, "Output mode", {name:"mode"});
    l_wnd.settings.mode.alignChildren = ["fill", "top"];
    l_wnd.settings.mode.add("radiobutton", undefined, "GUTimeline", {name:"gut_mode"});
    l_wnd.settings.mode.add("radiobutton", undefined, "JSON", {name:"json_mode"});
    l_wnd.settings.mode.add("checkbox", undefined, "Group mode", {name:"group_mode"});
    l_wnd.settings.mode.gut_mode.value = true;
    l_wnd.settings.mode.group_mode.enabled = false;
    ...
    {
        l_wnd.settings.mode.group_mode.enabled = false;
        l_wnd.settings.gut.enabled = true;
    }

    l_wnd.settings.mode.json_mode.onClick = function ()
    {
        l_wnd.settings.mode.group_mode.enabled = true;
        l_wnd.settings.gut.enabled = false;
    }

    l_wnd.settings.gut = l_wnd.settings.add("panel", undefined, "GUTimeline", {name:"gut"});
    l_wnd.settings.gut.alignChildren = ["fill", "top"];
    l_wnd.settings.gut.add("checkbox", undefined, "i_SET_SCALE_XY", {name:"sxsy_mode"});
    l_wnd.settings.gut.add("checkbox", undefined, "i_SET_XY", {name:"xy_mode"});
    l_wnd.settings.gut.sxsy_mode.value = true;
    ...
    l_wnd.settings.gut.max_error_group.add("edittext", undefined, _DEFAULT_MAX_ERROR.toString(), {name:"max_error"});
    l_wnd.settings.gut.max_error_group.max_error.characters = 2;

    l_wnd.settings.gut.linear_mode.onClick = function ()
    {
        l_wnd.settings.gut.max_error_group.enabled = l_wnd.settings.gut.linear_mode.value;
    }

    l_wnd.positioning = l_wnd.add("panel", undefined, "Positioning", {name:"positioning"});
    l_wnd.positioning.alignChildren = ["fill", "fill"];
    l_wnd.positioning.orientation = "row";
    l_wnd.positioning.resolution_group = l_wnd.positioning.add("group", undefined, {name:"resolution_group"});
    l_wnd.positioning.resolution_group.orientation = "column";
    l_wnd.positioning.resolution_group.alignChildren = ["fill", "fill"];
    l_wnd.positioning.resolution_group.force = l_wnd.positioning.resolution_group.add("checkbox", undefined, "Resolution", {name:"force"});
    l_wnd.positioning.resolution_group.x_group = l_wnd.positioning.resolution_group.add("group", undefined, {name:"x_group"});
    l_wnd.positioning.resolution_group.x_group.orientation = "row";
    l_wnd.positioning.resolution_group.x_group.add("statictext", undefined, "X:");
    l_wnd.positioning.resolution_group.x_group.width = l_wnd.positioning.resolution_group.x_group.add("edittext", undefined, "1920", {name:"width"});
    l_wnd.positioning.resolution_group.x_group.width.characters = 8;
    l_wnd.positioning.resolution_group.y_group = l_wnd.positioning.resolution_group.add("group", undefined, {name:"y_group"});
    l_wnd.positioning.resolution_group.y_group.orientation = "row";
    l_wnd.positioning.resolution_group.y_group.add("statictext", undefined, "Y:");
    l_wnd.positioning.resolution_group.y_group.height = l_wnd.positioning.resolution_group.y_group.add("edittext", undefined, "1080", {name:"height"});
    l_wnd.positioning.resolution_group.y_group.height.characters = 8;
    l_wnd.positioning.resolution_group.x_group.enabled = false;
    l_wnd.positioning.resolution_group.y_group.enabled = false;

    l_wnd.positioning.resolution_group.force.onClick = function ()
    {
        l_wnd.positioning.resolution_group.x_group.enabled = l_wnd.positioning.resolution_group.force.value;
        l_wnd.positioning.resolution_group.y_group.enabled = l_wnd.positioning.resolution_group.force.value;
    }

    l_wnd.positioning.separator = l_wnd.positioning.add("panel");
    l_wnd.positioning.separator.preferredSize = [0, 0];

    l_wnd.positioning.offset_group = l_wnd.positioning.add("group", undefined, {name:"offset_group"});
    l_wnd.positioning.offset_group.orientation = "column";
    l_wnd.positioning.offset_group.alignChildren = ["fill", "fill"];
    l_wnd.positioning.offset_group.force = l_wnd.positioning.offset_group.add("checkbox", undefined, "Offset", {name:"offset"});
    l_wnd.positioning.offset_group.x_group = l_wnd.positioning.offset_group.add("group", undefined, {name:"x_group"});
    l_wnd.positioning.offset_group.x_group.orientation = "row";
    l_wnd.positioning.offset_group.x_group.add("statictext", undefined, "X:");
    l_wnd.positioning.offset_group.x_group.offset_x = l_wnd.positioning.offset_group.x_group.add("edittext", undefined, "0", {name:"offset_x"});
    l_wnd.positioning.offset_group.x_group.offset_x.characters = 8;
    l_wnd.positioning.offset_group.y_group = l_wnd.positioning.offset_group.add("group", undefined, {name:"y_group"});
    l_wnd.positioning.offset_group.y_group.orientation = "row";
    l_wnd.positioning.offset_group.y_group.add("statictext", undefined, "Y:");
    l_wnd.positioning.offset_group.y_group.offset_y = l_wnd.positioning.offset_group.y_group.add("edittext", undefined, "0", {name:"offset_y"});
    l_wnd.positioning.offset_group.y_group.offset_y.characters = 8;
    l_wnd.positioning.offset_group.x_group.enabled = false;
    l_wnd.positioning.offset_group.y_group.enabled = false;

    l_wnd.positioning.offset_group.force.onClick = function ()
    {
        l_wnd.positioning.offset_group.x_group.enabled = l_wnd.positioning.offset_group.force.value;
        l_wnd.positioning.offset_group.y_group.enabled = l_wnd.positioning.offset_group.force.value;
    }

    l_wnd.btns_group = l_wnd.add("group", undefined, {name:"btns_group"});
    l_wnd.btns_group.orientation = "row";
    l_wnd.btns_group.add("button", undefined, 'Convert', {name:"ok"});
    l_wnd.btns_group.add("button", undefined, 'Cancel', {name:"cancel"}); 

    l_wnd.btns_group.ok.onClick = function ()
    {
        result = _exportObject(_getAnimationsObject());
    }

    l_wnd.btns_group.cancel.onClick = function ()
    {
        l_wnd.close();
        result = false;
    }
...
{
    return _fWindow_wnd.settings.mode.group_mode.value;
}

_isGUTimelineMode = function () //get if GUTimeline mode radiobutton is checked
{
    return _fWindow_wnd.settings.mode.gut_mode.value;
}
...
{
    var lProperties_arr = [];
    var lWinOptions_arr = _fWindow_wnd.settings.properties;
    for (var i = 0; i < _PROPERTIES.length; i++) 
    {
...
_getPropertiesGUT = function (aLayerName_str)
{
    ...
    for (var i = 0; i < lProperties_obj.srcNames.length; i++) 
    {
        if (
                ...
                && (!(_fWindow_wnd.settings.gut.sxsy_mode.value))
            )
        {
            ...
            lProperties_obj.mapping.push(i);
                    ...
                    && (!(_fWindow_wnd.settings.gut.xy_mode.value))
                )
        {
...
{
    var l_group = _fWindow_wnd.positioning.resolution_group;
    if (
...
{
    var l_group = _fWindow_wnd.positioning.offset_group;
    if (
            (l_group.enabled === false)
            || (l_group.force.value === false)
        )
...
{
    var lLayersContainer_panel = _fWindow_wnd.children[0];
...
_isArrayAscending = function (aSrc_arr, a_vsdo, aPropIndex_int) //ascending returns true, descending return false, unordered and empty return undefined
{
...
{
    var lText_str = _fWindow_wnd.settings.gut.max_error_group.max_error.text;
